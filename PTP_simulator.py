...
# Sidebar Inputs
param1 = st.sidebar.number_input("Start Position \n [(User Units)]", value=0,format="%.0f")
param2 = st.sidebar.number_input("End Position \n [(User Units)]", value=50,format="%.0f")
param3 = st.sidebar.number_input("Speed \n [(User Units)/sec]", value=1200,format="%.0f")
param4 = st.sidebar.number_input("Acceleration & Deceleration \n [(User Units)/sec^$2$]", value=24000,format="%.0f")
param6 = st.sidebar.number_input("Jerk [(User Units)/sec^$2$]", value=600000,format="%.0f")
